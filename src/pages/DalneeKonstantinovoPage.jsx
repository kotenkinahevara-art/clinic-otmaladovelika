          ...
          <div className="section--about__layout">
            <Motion.div className="section--about__intro" {...itemReveal}>
              ...
              <div className="intro__content">
                <p>
                  «Все создания от мала до велика» началась с простой мысли: в Дальнем Константинове должна быть ветклиника, где
                  питомца лечат профессионально, а владельца слышат и поддерживают. Мы росли шаг за шагом: от первых приемов и
                  базовой помощи до полноценной клиники с диагностикой, хирургией и продуманным сопровождением после лечения.
                </p>
                <p>
                  Для нас важно не только назначение и процедура, но и атмосфера. В клинике спокойно, бережно и по-человечески: без
                  спешки, с объяснениями понятным языком, с вниманием к характеру каждого животного. Мы знаем, как питомцы чувствуют
                  настроение вокруг, поэтому создаем пространство, где меньше стресса и больше доверия.
                </p>
                <p>
                  Сегодня мы продолжаем развиваться, чтобы в Дальнем Константинове можно было получить современную ветеринарную
                  помощь рядом с домом. Нам важно, чтобы после каждого визита у владельца оставалось ощущение уверенности, а у
                  питомца - спокойствия и заботы.
                </p>
              </div>
            </Motion.div>
